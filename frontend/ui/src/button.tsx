...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-white/30 to-white/10",
    inner: "bg-zinc-900",
...
const metalButtonVariants = (
  ...
  return {
    wrapper: cn(
      "relative inline-flex transform-gpu rounded-md p-[1.5px] will-change-transform overflow-hidden group shadow-2xl shadow-black/20",
      colors.outer,
    ),
    wrapperStyle: {
      transform: isPressed
...
export function AuroraButton({
  ...
  return (
    <div className="relative group transition-transform duration-300 hover:scale-105">
      ...
      <button
        className={cn(
          "relative rounded-lg bg-slate-950 px-4 py-2 flex items-center justify-center gap-2",
          "text-slate-100 shadow-xl min-h-14 px-8 text-base",
