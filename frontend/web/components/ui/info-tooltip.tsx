      ...
      <TooltipPrimitive.Root>
        ...
        <TooltipPrimitive.Portal>
          <TooltipPrimitive.Content
            sideOffset={4}
            className="z-[200] max-w-[280px] rounded-lg bg-[#111111] border border-[#222222] px-3 py-2.5 text-xs text-white shadow-xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 leading-relaxed"
          >
            {text}
